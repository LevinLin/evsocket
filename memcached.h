...
//add WEBSOCK_DATA_BUFFER_SIZE defination
#define WEBSOCK_DATA_BUFFER_SIZE 4096
...
/*
 * rewrite conn_states to work for websocket
 */
enum conn_states {
    conn_listening,  /**< the socket which listens for connections */
    conn_new_cmd,    /**< Prepare connection for next command */
    ...
    conn_websock_handshake,     /**< handle websocket handshake */        
    conn_websock_parse_head,    /**< try to parse websocket head */ 
    conn_websock_parse_body,    /**< try to parse websocket body */           
